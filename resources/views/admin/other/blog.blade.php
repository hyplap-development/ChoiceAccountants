...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Blogs</h1>
...
<div class="card">
    <div class="card-body p-0">
        ...
        <div class="card-px text-center py-20 my-10">
            <h2 class="fs-2x fw-bold mb-10">No Blogs Found</h2>
            <p class="text-gray-400 fs-4 fw-semibold mb-10">Looks like you do not have any blog here.
...
<div class="card">
    ...
    <div class="card-body pt-0" id="tableDiv">
        <table class="table align-middle table-row-dashed fs-7x gy-6x" id="data_table">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="symbol symbol-50px">
                            <img src="{{ $data->image == null ? 'assets/media/blankimg.svg' : $data->image }}" alt="image" onerror="src='/assets/media/blankimg.svg'" />
                        </div>
                    </td>
                    <td class="text-center">
                        {{ $data->title }}
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{url('blog/delete')}}" id="UserDeleteForm{{$data->id}}" method="post">
                                ...
                                <div class="modal-body">
                                    <span>Are you sure you want to delete this blog? <br> Action cannot be reverted</span>
                                </div>
