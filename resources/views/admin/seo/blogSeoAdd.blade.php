...
@section('title','SEO Content For Blog')
...
@section('content')
<form action="{{url('/seo/addseo')}}" id="kt_modal_add_form" enctype="multipart/form-data" method="post">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <h4 style="color: #f1416c;">You can only upload one from either an image or a URL</h4>
                        ...
                        <div class="col-md-4 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Select Blog</label>
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Blog" data-hide-search="false" data-dropdown-parent="#kt_modal_add_form" name="fieldId" id="fieldId">
                                <option value=""></option>
