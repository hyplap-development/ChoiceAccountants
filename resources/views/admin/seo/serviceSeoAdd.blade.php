...
@section('content')
<form action="{{url('/seo/addserseo')}}" id="kt_modal_add_form" enctype="multipart/form-data" method="post">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <h4 style="color: #f1416c;">You can only upload one from either an image or a URL</h4>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Service" data-hide-search="false" data-dropdown-parent="#kt_modal_add_form" name="fieldId" id="fieldId">
                                <option value=""></option>
