...
@section('title','SEO Content For Service')
...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">SEO Content For Service</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-muted">
        <a href="{{url('/seo/service')}}" class="text-muted text-hover-primary">Services</a>
    </li>
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-200 w-5px h-2px"></span>
    </li>
    <li class="breadcrumb-item text-dark">SEO Content For Service</li>
</ul>
@endsection

@section('content')
<form action="{{url('/seo/updateserseo')}}" id="kt_modal_add_form" enctype="multipart/form-data" method="post">
    @csrf
                ...
                <div class="card-body">
                    <div class="row g-9 mb-7">
                        <div>
                            ...
                            <h4 style="color: #268d44; display: inline; float: right;">{{$service->name}}</h4>
                        </div>
