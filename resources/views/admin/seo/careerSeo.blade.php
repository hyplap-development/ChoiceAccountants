...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">SEO For Career Opportunities</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-dark">SEO For Career Opportunities</li>
</ul>
...
<div class="card">
    <div class="card-body p-0">
        ...
        <div class="card-px text-center py-20 ">
            <h2 class="fs-2x fw-bold mb-10">No SEO Content For Career Opportunity</h2>
            ...
            <a href="{{url('seo/showAddcarseo')}}" class="btn btn-primary">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="data_table">
            <thead>
                <tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-center min-w-25px">Career Opportunity Name</th>
            ...
            <tbody class="fw-semibold text-gray-600">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        {{$data->career->title}}
                        @else
                        <span class="text-danger">No Career Opportunity Selected</span>
                        @endif
                    </td>
                    <td class="text-center">
                        <a href="{{url('/seo/viewcarseo')}}/{{$data->id}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                            <span class="svg-icon svg-icon-3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <form action="{{url('seo/deletecarseo')}}" id="UserDeleteForm{{$data->id}}" method="post">
                                @csrf
                                <input type="hidden" value="{{$data->id}}" name="hiddenId">
                                <div class="modal-body">
                                    <span>Are you sure you want to delete SEO Content for this career opportunity ? <br> Action cannot be reverted</span>
                                </div>
