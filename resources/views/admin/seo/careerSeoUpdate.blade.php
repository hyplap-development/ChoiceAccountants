...
@section('title','SEO Content For Career Opportunity')
...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">SEO Content For Career Opportunity</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-muted">
        <a href="{{url('/seo/careeropportunity')}}" class="text-muted text-hover-primary">Career Opportunities</a>
    </li>
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-200 w-5px h-2px"></span>
    </li>
    <li class="breadcrumb-item text-dark">SEO Content For Career Opportunity</li>
</ul>
@endsection

@section('content')
<form action="{{url('/seo/updatecarseo')}}" id="kt_modal_add_form" enctype="multipart/form-data" method="post">
    @csrf
    <input type="hidden" name="hiddenId" value="{{$seo->id}}">
                ...
                <div class="card-body">
                    <div class="row g-9 mb-7">
                        <div>
                            ...
                            <h4 style="color: #268d44; display: inline; float: right;">{{$careeropportunity->title}}</h4>
                        </div>
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-center flex-column py-5 mb-1">
                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                    <?php
                                    if ($seo->ogImage != null) {
                                        $placeholderblankImage = $seo->ogImage;
                                    } else {
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Add Image">
                                        ...
                                        <input type="file" name="ogImage" accept="image/*" value="{{$seo->ogImage }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="d-flex flex-center flex-column py-5 mb-1">
                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                    <?php
                                    if ($seo->twitterImage != null) {
                                        $placeholderblankImage = $seo->twitterImage;
                                    } else {
                                        $placeholderblankImage = config('placeholderblankImage');
                                    }
                                    ?>
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Add Image">
                                        <i class="bi bi-pencil-fill fs-7"></i>
                                        <input type="file" name="twitterImage" accept="image/*" value="{{$seo->twitterImage }}" />
                                        <input type="hidden" name="avatar_remove" />
                                    </label>
                                    <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="Cancel Image">
                                        <i class="bi bi-x fs-2"></i>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Open Graph Image Url" id="ogImageurl" name="ogImageurl" value="{{$seo->ogImage}}">
                            <span id="errormsgimg2"></span>
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Or Twitter Image Url</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Twitter Image Url" id="twitterImageurl" name="twitterImageurl" value="{{$seo->twitterImage}}">
                            <span id="errormsgimg3"></span>
                        </div>
                        <input type="hidden" name="fieldId" id="fieldId" value="{{$seo->fieldId}}">
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Title" id="title" name="title" value="{{$seo->title}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Meta Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Meta Title" id="metaTitle" name="metaTitle" value="{{$seo->metaTitle}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Open Graph Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Open Graph Title" id="ogTitle" name="ogTitle" value="{{$seo->ogTitle}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Facebook Open Graph Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Facebook Title" id="fbogTitle" name="fbogTitle" value="{{$seo->fbogTitle}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Twitter Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Twitter Title" id="twitterTitle" name="twitterTitle" value="{{$seo->twitterTitle}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Item Property Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Item Property Title" id="ipTitle" name="ipTitle" value="{{$seo->ipTitle}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Dublin Core Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Dublin Core Title" id="dcTitle" name="dcTitle" value="{{$seo->dcTitle}}">
                        </div>

                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Dublin Core Creator</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Dublin Core Creator" id="dcCreator" name="dcCreator" value="{{$seo->dcCreator}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Meta Keyword</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Meta Keywords" name="metaKeyword" id="metaKeyword" value="{{$seo->metaKeyword}}">
                        </div>
                        <div class="col-md-3 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Meta Author Name</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Meta Author Name" id="metaAuthor" name="metaAuthor" value="{{$seo->metaAuthor}}">
                        </div>
                        <div class="col-md-3 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Option" data-hide-search="true" name="metaRobot[]" id="metaRobot" multiple>
                                <option value=""></option>
                                <option value="index" {{in_array('index', explode(',', $seo->metaRobot)) ? 'selected' : ''}}>Index</option>
                                <option value="noindex" {{in_array('noindex', explode(',', $seo->metaRobot)) ? 'selected' : ''}}>No Index</option>
                                <option value="follow" {{in_array('follow', explode(',', $seo->metaRobot)) ? 'selected' : ''}}>Follow</option>
                                <option value="nofollow" {{in_array('nofollow', explode(',', $seo->metaRobot)) ? 'selected' : ''}}>No Follow</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select Type" data-hide-search="true" name="twitterType" id="twitterType">
                                <option value=""></option>
                                <option value="App" {{$seo->twitterType == 'App' ? 'selected' : ''}}>App</option>
                                <option value="Player" {{$seo->twitterType == 'Player' ? 'selected' : ''}}>Player</option>
                                <option value="Summery" {{$seo->twitterType == 'Summery' ? 'selected' : ''}}>Summery</option>
                                <option value="Summerywithlargeimage" {{$seo->twitterType == 'Summerywithlargeimage' ? 'selected' : ''}}>Summerywithlargeimage</option>
                            </select>
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Facebook Open Graph Type</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Facebook Open Graph Type" id="fbogType" name="fbogType" value="{{$seo->fbogType}}">
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Facebook Open Graph Site Name</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Facebook Open Graph Site Name" id="fbogSiteName" name="fbogSiteName" value="{{$seo->fbogSiteName}}">
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row g-9 mb-7">
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" placeholder="Enter Meta Description" id="metaDescription" name="metaDescription" rows="5">{{$seo->metaDescription}}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">Open Graph Description</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter Open Graph Description" id="ogDescription" name="ogDescription" rows="5">{{$seo->ogDescription}}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">Facebook Open Graph Description</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter Open Graph Description" id="fbogDescription" name="fbogDescription" rows="5">{{$seo->fbogDescription}}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">Twitter Description</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter Twitter Description" id="twitterDescription" name="twitterDescription" rows="5">{{$seo->twitterDescription}}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">Item Property Description</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter Item Property Description" id="ipDescription" name="ipDescription" rows="5">{{$seo->ipDescription}}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">Dublin Core Description</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter Dublin Core Description" id="dcDescription" name="dcDescription" rows="5">{{$seo->dcDescription}}</textarea>
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-9 mb-7">
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" placeholder="Enter Schema" id="schema1" name="schema1" rows="8">{!!$seo->schema1!!}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">Schema 2</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter Schema" id="schema2" name="schema2" rows="8">{!!$seo->schema2!!}</textarea>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
