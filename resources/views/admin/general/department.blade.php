...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Departments</h1>
...
<div class="card">
    <div class="card-body p-0">
        ...
        <div class="card-px text-center py-20 ">
            ...
            <a href="{{url('department/showAdd')}}" class="btn btn-primary">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="data_table">
            <thead>
                <tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-center min-w-25px">Banner Image</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="symbol symbol-50px">
                            <img src="{{$data->image != null ? $data->image : 'assets/media/blankimg.avg'}}" alt="Image" onerror="src='/assets/media/blankimg.svg'" />
                        </div>
                    </td>
                    <td class="text-center">
                        <div class="symbol symbol-50px">
                            <img src="{{$data->bannerImage != null ? $data->bannerImage : 'assets/media/blankimg.avg'}}" alt="Banner Image" onerror="src='/assets/media/blankimg.svg'" />
                        </div>
                    </td>
                    <td class="text-center">
                        {{ $data->name }}
                    ...
                    <td class="text-center">
                        <a href="{{url('/department/view')}}/{{$data->id}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                            <span class="svg-icon svg-icon-3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <form action="{{url('department/delete')}}" id="UserDeleteForm{{$data->id}}" method="post">
                                @csrf
                                <input type="hidden" value="{{$data->id}}" name="departmentId">
                                <div class="modal-body">
                                    <span>Are you sure you want to delete department {{$data->name}}? <br> Action cannot be reverted</span>
                                </div>
