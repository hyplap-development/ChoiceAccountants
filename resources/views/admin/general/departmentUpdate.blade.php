...
@section('content')
<form autocomplete="off" action="{{url('/department/update')}}" enctype="multipart/form-data" method="post" id="kt_modal_add_form">
    @csrf
                ...
                <div class="card-body">
                    <div class="row g-9 mb-1">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                    ...
                                    if ($department->image != null) {
                                        $placeholderblankImage = $department->image;
                                    } else {
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change Image">
                                        ...
                                        <input type="file" name="image" accept="image/*" value="{{ $department->image }}" />
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Alt Tags" name="imgAlt" id="imgAlt" value="{{$department->imgAlt}}">
                        </div>
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                <div class="image-input image-input-outline" data-kt-image-input="true">
                                    <?php
                                    if ($department->bannerImage != null) {
                                        $placeholderblankImage = $department->bannerImage;
                                    } else {
                                        $placeholderblankImage = config('placeholderblankImage');
                                    }
                                    ?>
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Add Image">
                                        <i class="bi bi-pencil-fill fs-7"></i>
                                        <input type="file" name="bannerImage" accept="image/*" value="{{ $department->bannerImage }}" />
                                        <input type="hidden" name="avatar_remove" />
                                    </label>
                                    <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="Cancel Image">
                                        <i class="bi bi-x fs-2"></i>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Alt Tags" name="bannerImgAlt" id="bannerImgAlt" value="{{$department->bannerImgAlt}}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-9 mb-1">
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Department Name" id="name" name="name" value="{{$department->name}}">
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">URL</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter URL" name="url" id="url" value="{{$department->url ? $department->url : $department->name}}">
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="required d-flex align-items-center fs-6 fw-semibold mb-2">Add Home Page Description</label>
                            <input class="form-control form-control-solid" placeholder="Enter Home Page Description" id="homePageDes" name="homePageDes" value="{{$department->homePageDes}}"></textarea>
                        </div>
                        <div class="col-md-9 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Title</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Title" name="title" id="title" value="{{$department->title}}">
                        </div>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" placeholder="Enter Short Description" id="shortDescription" name="shortDescription" rows="5">{!!$department->shortDescription!!}</textarea>
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Subtitle</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Enter Subtitle" name="subtitle" id="subtitle" value="{{$department->subtitle}}">
                        </div>
                        <div class="col-md-12 fv-row">
                            <label class="required d-flex align-items-center fs-6 fw-semibold mb-2">Add Description</label>
                            <textarea class="form-control form-control-solid" placeholder="Enter description" id="description" name="description" rows="5">{!!$department->description!!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
