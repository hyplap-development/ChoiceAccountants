...
@section('breadcrumb')
<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Our Clients</h1>
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
    ...
    <li class="breadcrumb-item text-dark">Our Clients</li>
</ul>
...
<div class="card">
    <div class="card-body p-0">
        ...
        <div class="card-px text-center py-20 ">
            <h2 class="fs-2x fw-bold mb-10">No Client Found</h2>
            <p class="text-gray-400 fs-4 fw-semibold mb-10">Looks like you do not have any client here.
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="data_table">
            <thead>
                <tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-center min-w-25px">Client Logo</th>
                    <th class="text-center min-w-125px">Client Name</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="symbol symbol-50px">
                            <img src="{{$data->logo != null ? $data->logo : 'assets/media/blankimg.svg'}}" alt="Image" onerror="src='/assets/media/blankimg.svg'" />
                        </div>
                    </td>
                    <td class="text-center">
                        {{ $data->name }}
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-1000px">
                        <div class="modal-content rounded">
                            <div class="modal-header">
                                <h1 class="modal-tital w-100 text-center"> Update Client {{ $data->name }} </h1>
                            ...
                            <form autocomplete="off" action="{{url('client/update')}}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            <div class="row g-9 mt-3">
                                                <div class="col-md-12 fv-row">
                                                    <label class="required fs-6 fw-semibold mb-2">Client Logo</label>
                                                    <div class="d-flex flex-center flex-column py-5 mb-1">
                                                        <div class="image-input image-input-outline" data-kt-image-input="true">
                                                            <?php
                                                            if ($data->logo != null) {
                                                                $placeholderblankImage = $data->logo;
                                                            } else {
                                                            ...
                                                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="change Image">
                                                                ...
                                                                <input type="file" name="logo" accept="image/*" value="{{ $data->logo }}" />
                                        ...
                                        <div class="col-md-8 fv-row">
                                            <div class="row g-9 mt-3">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Name" name="name" value="{{$data->name}}" id="name{{$data->id}}">
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <label class="fs-6 fw-semibold mb-2">Logo Alt Tags (Comma Seperated)</label>
                                                ...
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="number" class="form-control form-control-solid" placeholder="Enter Sequence" name="sequence" value="{{$data->sequence}}" id="sequence{{$data->id}}" min="0">
                                                </div>
                                                <div class="col-md-6 fv-row">
                ...
                <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <form action="{{url('client/delete')}}" id="UserDeleteForm{{$data->id}}" method="post">
                                @csrf
                                <input type="hidden" value="{{$data->id}}" name="clientId">
                                <div class="modal-body">
                                    <span>Are you sure you want to delete client {{$data->name}}? <br> Action cannot be reverted</span>
                                </div>
                                <div class="modal-footer">
...
<div class="modal fade" id="addmodal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-1000px">
        <div class="modal-content rounded">
            <div class="modal-header">
                <h1 class="modal-tital w-100 text-center"> Add Client </h1>
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <span class="svg-icon svg-icon-1">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
            ...
            <form autocomplete="off" action="{{url('/client/add')}}" enctype="multipart/form-data" method="post" id="kt_modal_add_form">
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    @csrf
                    <div class="row">
                        <div class="col-md-4 fv-row">
                        ...
                        <div class="col-md-8 fv-row">
                            <div class="row g-9 mt-3">
                                <div class="col-md-6 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Client Name</label>
                                    <input type="text" class="form-control form-control-solid" placeholder="Enter Name" name="name" id="name">
                                </div>
                                <div class="col-md-6 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Logo Alt Tags (Comma Seperated)</label>
                    ...
                    n = FormValidation.formValidation(r, {
                        fields: {
                            ...
                            logo: {
                                validators: {
                                    notEmpty: {
                                        message: "Select client logo is required"
                                    },
                                }
                            },
